...
class ApiConstants {
  ...
  static String studentEventsEndpoint(int studentId) =>
      '$v2BaseUrl/students/$studentId/events';
  ...
  // ============================================
  static String get notificationsEndpoint => '$v2BaseUrl/student/notifications';
